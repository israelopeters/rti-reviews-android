...
class TestData {
    companion object {
        private val authorReviews: Set<Review> = HashSet()
        private val user: User = User(1L, "Israel", "Peters", "UK", "This is me", "israel@email.com", "password", LocalDate.now(), authorReviews, listOf())
        ...
        fun saveNewReview(newReview: NewReviewUiState) {
            val review = Review(
                ...
                likeCount = newReview.newReview.likeCount,
